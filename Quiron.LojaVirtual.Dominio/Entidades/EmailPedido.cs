...
namespace Quiron.LojaVirtual.Dominio.Entidades
{
    public class EmailPedido
    {
        ...
        ///     Construtor
        /// </summary>
        /// <param name="_emailConfiguracoes"></param>
        public EmailPedido(EmailConfiguracoes _emailConfiguracoes)
        {
            this._emailConfiguracoes = _emailConfiguracoes;        
        }

        /// <summary>
        ///     Envia um e-mail para o cliente, encerrando o pedido
        /// </summary>
        /// <param name="carrinho">Carrinho</param>
